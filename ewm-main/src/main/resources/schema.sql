--DROP TABLE IF EXISTS compilation_event, compilations, requests, events, locations, categories, subscriptions, users;
...
CREATE TABLE IF NOT EXISTS subscriptions (
  ...
  CONSTRAINT fk_subscriptions_subscription FOREIGN KEY (subscription_id) REFERENCES users(id) ON DELETE CASCADE
);
